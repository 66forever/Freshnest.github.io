  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <section id="billboard" class="overflow-hidden">
      <section class="home"> 
              ...
              <img src="hmpng/SRV-HOME.jpg" class="SRV-HOME" alt="SRV-HOME">
                 
              </div>
              <div class="home-content">
                  <div class="overlay-text">
                      <h1>Keep up with the latest Blogs</h1>
                      <p>"With our top-rated cleaning services we provided articles!! "</p>
    ...
    <div width="18px" height="700px"></div> <!-- problem with spaces -->
