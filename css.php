...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $timePeriod = $_POST['timePeriod']; // AM or PM
    ...
    if ($areaSize > 36) {
        $areaCost += ($areaSize - 36) * 70; // Additional cost for extra sqm
    }
    ...
    $_SESSION['booking'] = [
        ...
        'timePeriod' => $timePeriod, // Store AM/PM
        'areaSize' => $areaSize,
        'services' => $services,
...
<html>
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <section class="container mt-5">
        ...
        <p>Service Time: <?php echo htmlspecialchars($serviceTime) . ' ' . htmlspecialchars($timePeriod); ?></p> <!-- Display AM/PM -->
