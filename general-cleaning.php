...
<html>
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
          ...
          <div class="col-lg-6">
            <div class="detail p-5">
              <div class="display-header">
                ...
                <h2 class="" > General Cleaning</h2>
                <p class="pb-3" style="text-align: justify;">General Cleaning provides a thorough, top-to-bottom clean for homes and commercial properties, ensuring a spotless space.</p>
                  ...
                  <ul style="text-align: justify;">
                      ...
                      <li>Polish kitchen and bathroom counter-tops, fixtures, and fittings</li>
                      <li>Vacuum upholstery and carpets, Vacuum and clean screens and window/sliding door railings</li>
                      <li>Vacuum and mop floor, Steam clean floor (Depending on flooring)</li>
                      <li>Polish windows, mirrors, glass panels, and glass doors (except if scaffolding required), Polish doors and door frames, Polish tables and chairs</li>
                  </ul>
                  ...
                  <ul style="text-align: justify;">
                      <li>Base rate: ₱3,000 (Makati area)</li>
    ...
    <!-- SELECT DATE -->
    <form id="bookingForm" method="POST" action="general-process_booking.php">
        ...
        <div class="form-group time-area-container">
         <!-- SELECT TIME -->
            ...
            <div class="form-group area-size-section">
                ...
                <div class="areact">Area Cost: ₱<span id="areaCost">3050.00</span></div>
        ...
        <!-- Regular Addons Section -->
            <div class="form-group addon-regular">
                ...
                <input type="checkbox" id="regularCleaning" name="services[]" value="Regular Cleaning: 2520.00" data-price="2520.00" onclick="updateAddonTotal()">
                <label for="regularCleaning">Regular Cleaning </label><br>
        ...
        <div class="upholstery-cleaning">
            ...
            <div class="total-price">
                Total Price: ₱<span id="totalPrice">3050.00</span>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
                ...
                addonCheckboxes.forEach((addon) => {
                    if (addon.checked) {
                        ...
                        if (qtyInput) {
                            ...
                            // For regular addons without quantity (like Regular Cleaning and Duo Disinfection)
            ...
            document.querySelectorAll('input[type="checkbox"][name="services[]"]').forEach(checkbox => {
                checkbox.addEventListener('change', function() {
                    if (this.id === 'regularCleaning' || this.id === 'duoDisinfection') {
