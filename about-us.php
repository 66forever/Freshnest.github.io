...
<html>
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <section id="mission-visionsec">
            <div class="mission-vision section">
                <div class="mission">
                    <h2><i class="fas fa-play"></i> Our Mission</h2>
                    <p>At Freshnest Cleaning Service, our mission is to provide exceptional cleaning experiences that exceed our customers' expectations. We strive to deliver reliable, efficient, and eco-friendly cleaning solutions that make a positive impact on our customers' lives. We aim to build long-term relationships with our clients by providing personalized attention, flexible scheduling, and a commitment to quality that sets us apart from the competition.</p>
                  </div>
                  <div class="vision">
                    <h2><i class="fas fa-play"></i> Our Vision</h2>
                    <p>Our vision at Freshnest Cleaning Service is to be the go-to cleaning partner for homes and businesses in Metro Manila. We envision a future where every space is clean, healthy, and sparkling, and where our customers feel confident and relaxed in their environments. We see ourselves as leaders in the cleaning industry, driving innovation and sustainability, and making a positive difference in our community.</p>
                  </div>
                </div>
            ...
            <div class="core-values section">
                <h2>Our Core Values</h2>
                    <div class="values">
                        <div class="value">
                            <h3><span>Service Excellence</span></h3>
                            <p>We deliver exceptional cleaning services that exceed our clients' expectations. Our team of professionals takes pride in their work, ensuring every home and office is cleaned to perfection.</p>
                          </div>
                          
                          <div class="value">
                            <h3><span>Proactive</span></h3>
                            <p>We anticipate our clients' needs and act in advance to address challenges. Our team seeks innovative solutions to enhance our services and operations, ensuring we stay ahead of the curve.</p>
                          </div>
                          
                          <div class="value">
                            <h3><span>Respect</span></h3>
                            <p>We treat everyone with respect and dignity, conducting our business with integrity and building trust with our clients, employees, and partners.</p>
                          </div>
                          
                          <div class="value">
                            <h3><span>Unity</span></h3>
                            <p>We believe in teamwork and unity, working collaboratively to ensure every client receives a seamless and exceptional service. We support each other's growth and development.</p>
                          </div>
                          
                          <div class="value">
                            <h3><span>Customer Focus</span></h3>
                            <p>We understand our clients' unique needs and preferences, tailoring our services to meet their expectations. We're dedicated to providing a personalized service that exceeds their expectations.</p>
                          </div>
                          
                          <div class="value">
                            <h3><span>Environmental Responsibility</span></h3>
                            <p>We use eco-friendly cleaning products and practices, minimizing our environmental impact. We're committed to providing a cleaning service that keeps our clients' homes and offices clean while protecting the planet.</p>
                          </div>
                    </div>
            </div>
